void main() {
  ...
  */
  ...
  // Menyiapkan variabel sesuai dengan tipe datanya
  ...
  // Daftar makanan dalam bentuk list of maps
  ...
  // Daftar minuman dalam bentuk list of maps
  ...
  // Membuat map restoran menggunakan variabel yang telah dibuat
  Map restoran = {
    'nama': nama,
    'tahun': tahun,
    'pemilik': pemilik,
